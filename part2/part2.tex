...
\begin{itemize}
        ...
        \item truthLit :: Lit t -> Truth t\\
                Get the truth value of a Literal
        \item stringLit :: Lit t -> String\\
        ...
        \item smartCNF :: Ha hedge => [Lit hedge] -> CNF (Lit hedge)
                Sorts the list of Literals before construct a
                disjunction.
        \item sortCNF :: Ha hedge => CNF (Lit hedge) -> CNF (Lit hedge)
                Sort the Literals in a disjunction.
        \item sortLits :: Ha hedge => [Lit hedge] -> [Lit hedge]
...
resolution :: Ha hedge => [Clause hedge] -> (Maybe
(Truth hedge), [(Clause hedge, Clause hedge, Clause hedge)])

resolution' :: Ha hedge => [Clause hedge] ->
